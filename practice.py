...
def main(stdscr):
    ...
    # Allow snake to move at least once before checking game over conditions
    snake_moved = False
    ...
    while True:
        ...
        if snake_moved and new_head in snake:
            game_over_reason = "Snake ran into itself!"
            break
        if new_head in obstacles:
            game_over_reason = "Snake ran into an obstacle!"
            break
    ...
    stdscr.addstr(screen_height // 2 + 3, screen_width // 2 - 10, game_over_reason)
    stdscr.refresh()
